...
urlpatterns = [
   ...
   path('requisitions', views.RequisitionView.as_view()),
   path('requisitions/<str:id>', views.RequisitionView.as_view()),
   path('requisition_stockout_item/<str:requisition_id>', views.RequisitionItemForStockoutView.as_view()),
   path("reservations", views.ReservationView.as_view()),
   path("reservations/<str:id>", views.ReservationView.as_view()),
   path('reservation_stockin_item/<str:reservation_id>', views.ReservationItemForStockinView.as_view()),
   path('search/requisitions', views.SearchRequisitionsView.as_view()),
   path('search/reservations', views.SearchReservationsView.as_view()),
