...
from AdminApp.utils import Syserror, validate_quantity
            ...
            if view_type == "weekly":
                ...
                for i in date_list:
                    ...
                    stock_item = (
                        ...
                        .aggregate(
                            stock_in=Coalesce(
                                Sum("quantity", filter=Q(is_stock_out=False)), 0, output_field=FloatField()
                            ),
                            stock_out=Coalesce(
                                Sum("quantity", filter=Q(is_stock_out=True)), 0, output_field=FloatField()
                            ),
                        )
                    )
    ...
    def get(self, request):
        try:
            ...
            instance = (
                ...
                .annotate(
                    total_stock_out=Coalesce(Sum("quantity"), 0, output_field=FloatField()),
                    total_stock_out_price=ExpressionWrapper(
