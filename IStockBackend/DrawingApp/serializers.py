...
#         ret = super(DrawingListSerializer, self).to_representation(obj)
#         ret['department'] = {
#                 "name":obj.department.name
#             } if obj.department else None
#         ret['unit'] = {"name":obj.unit.name} if obj.unit else None
        
#         ret['volume'] = {
#                 "name":obj.sub_volume.name,
#                 "volume_name":obj.sub_volume.volume.name
#             } if obj.sub_volume else None
#         ret['files'] = obj.files.select_related('drawing').all().order_by('file_name').values('id', 'file_name')
        
#         return ret
#     class Meta:
#         model = Drawing
#         fields = ["id", "drawing_type", "drawing_number", "revision_version", "work_order_number", "is_layout", "default_description"]
...
# class SearchDrawingSerializer(serializers.ModelSerializer):
#     def to_representation(self, obj):
