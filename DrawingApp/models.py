...
from core.utility import getId, extract_sheet_number, get_only_file_name, Syserror
...
class DrawingLog(models.Model):
    ...
    drawing = models.ForeignKey(Drawing, on_delete=models.SET_NULL, null=True, db_index=True, related_name="logs")
...
def convert_TIF_Pdf(instance:DrawingFile):
    try:
