...
from AuthApp.models import User, Unit, Department, LogInOutLog, Subvolume,Volume, OldDepartment
...
class OldDepartmentSerializer(serializers.ModelSerializer):
    def to_representation(self, obj):
        ret = super(OldDepartmentSerializer, self).to_representation(obj)
        ret['new_department'] = {
            "department_id":obj.new_department.department_id,
            "name":obj.new_department.name
        }
        return ret
